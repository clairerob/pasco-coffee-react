...
<Modal.Header closeButton >
	<Modal.Title>{name} class: {date}</Modal.Title>
</Modal.Header>
<Modal.Body>

	form probably with formik to connect to stripe payment page but not building until I look at stripe docs
	
</Modal.Body>
<Modal.Footer>
	<div><Button onClick={handleClose}>close</Button></div>
	<div><Button onClick={handleClose}>confirm and continue to payment bit</Button></div>
	</Modal.Footer>
</Modal>
</>
	);
